...
//==============================================================================
//==============================================================================
rs::insertion_sort::insertion_sort()
{
...
//==============================================================================
void
rs::insertion_sort::display_list(
  std::list<int> &l, 
  std::list<int>::iterator &cwit)
{
...
//==============================================================================
void
rs::insertion_sort::display_list(std::list<int> &l)
{
  for(std::list<int>::iterator it = l.begin(); it != l.end(); it++)
  {
      printf(" %d", *it);
...
//
void
rs::insertion_sort::exec(const int *pinput, const int *pend, int *poutput)
{
